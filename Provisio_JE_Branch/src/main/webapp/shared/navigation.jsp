 <nav class="site-header sticky-top py-1 navbar navbar-dark bg-dark">
   <div class="container d-flex flex-column flex-md-row justify-content-between">
     ...
     <a class="py-2 d-none d-md-inline-block" href="/reservation.jsp">Reserve Now</a>
      <a class="py-2 d-none d-md-inline-block" href="register.jsp">Register</a>
     <a class="py-2 d-none d-md-inline-block" href="/login.jsp">Login</a>
     <!--  If user logged in  -->
     <a class="py-2 d-none d-md-inline-block" href="/lookup.jsp">Lookup</a>
      <a class="py-2 d-none d-md-inline-block" href="/rewards.jsp">Rewards</a>
     <a class="py-2 d-none d-md-inline-block" href="/summary.jsp">Summary</a>
      <a class="py-2 d-none d-md-inline-block" href="/logout.jsp">Logout</a>
   </div>
 </nav>